      ...
      <div className="flex-1 px-6 py-4 flex flex-col justify-center">
        <Card className="border-0 shadow-lg overflow-hidden">
          ...
          <CardHeader className="text-center pb-4">
            ...
            <p className="text-gray-600">Sign in to continue your smart shopping</p>
          </CardHeader>
          ...
          <CardContent className="space-y-5">
            <Tabs defaultValue="email" className="w-full">
              ...
              <TabsContent value="phone" className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="otp" type="text" placeholder="Enter verification code" className="h-12" />
                </div>
            ...
            <Button asChild className="w-full h-12 text-lg bg-primary hover:bg-primary-600">
              <Link href="/vision-setup">Sign In</Link>
            </Button>
